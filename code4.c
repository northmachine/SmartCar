...
PIDP steer = {1.18, 0.04, 2.7,10,0,0,0,0};
void sd5_init(){
...
void sd5_control(){
  ...
  if((AD0+AD1)>1800 && steer.errdat<0 && steer.errdat>-200){
    FTM_PWM_Duty(ftm0,ftm_ch0,430);
    Soft_Delay_ms(620);
    FTM_PWM_Duty(ftm0,ftm_ch0,485);
    Soft_Delay_ms(550); 
  }
  else if((AD0+AD1)>1800 && steer.errdat<200 && steer.errdat>0){
    FTM_PWM_Duty(ftm0,ftm_ch0,430);
    Soft_Delay_ms(620);
    FTM_PWM_Duty(ftm0,ftm_ch0,375);
    Soft_Delay_ms(550);
